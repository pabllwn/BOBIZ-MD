...
module.exports = {
    SESSION: process.env.BOBIZ_SESSION === undefined ? '' : process.env.Code_SESSION,
    URL_1NAME: process.env.URL_1NAME === undefined ? '🎃Follow me on Instagram🎃' : process.env.URL_1NAME,
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/' : process.env.URL_1LINK,
    ...
    FOOTER: process.env.FOOTER === undefined ? 'BOBIZBOT-MD   تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? 'skt' : process.env.CAPTION,
